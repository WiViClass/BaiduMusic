...
typedef LRESULT (CNotifyPump::*DUI_PPARAM)(WPARAM wParam, LPARAM lParam);  //指针类型
...
#define DUI_MSGTYPE_RBUTTONMENU		   	   (_T("rbuttonmenu"))
...
#define USER_MSG( msgid, func ) \
	{ msgid, _T(""), DuiSig_lwl, (DUI_PPARAM)&func },
...
#define  DUI_CTR_ANIMATION                        (_T("Animate"))
