...
namespace DuiLib {
	...
	bool CRenderEngine::DrawImageAnim(HDC hDC,CPaintManagerUI* pManager,LPCTSTR pStrImage, const RECT& rc,const RECT& rcBmpPart )
	{
		...
		DuiLib::DrawImage(hDC, pManager, rc, rc, sImageName, sImageResType,
			rcItem, rcBmpPart, rcCorner, dwMask, bFade, bHole, bTiledX, bTiledY);
