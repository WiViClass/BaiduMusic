...
CMusicPlayer::CMusicPlayer(CDuiFrameWnd *pMainFrame):
...
CDuiFrameWnd* CMusicPlayer::GetMainFrame() const
{
	return m_pMainFrame;
}

void CMusicPlayer::InitPlayer(PLAY_PROC playProc)
{
